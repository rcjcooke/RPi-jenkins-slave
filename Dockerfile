...
RUN sudo apt-get update -qq && sudo apt-get install -y apt-utils openssh-server ca-certificates && sudo apt-get -t wheezy-backports install git && sudo apt-get clean
